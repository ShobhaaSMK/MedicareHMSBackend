...
// Sample PatientLabTest records for RoomAdmission (IPD) patients
...
const patientLabTests = [
  ...
  {
    PatientType: "IPD",
    PatientId: "d2023e9e-5b6e-4e22-ba5b-992b6780a72f", // Anjali - from RoomAdmission ID 5
...
async function main() {
  console.log('Creating Patient Lab Test records for RoomAdmission (IPD) patients...\n');
